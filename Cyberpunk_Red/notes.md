...
fangen mit der sicherung des tatorts
von innen ist der laden koplett zerstört -> struckturelle schäden
  keine sprengung an sich aber kleinere expolsionen von waffen
  muss von mehreren personen (halbes duzend) verwüstet worden sein
  unkoordiniert, mangel an disziplin
  finde ein nicht definiertes explosiv monition von einer schweren pistole; im unterbau versenkt
  explosiv muni ist die ausnahme, rifle muni ist das meinste, meist std. muni 
  gibt ein paar explsv geschosse, heavy weapon war nicht im einsatz
  gab ein paar stupf bei zu se waffen, eine person mit klingen waffen
  tatzeit: halb 5 morgens, 
  die tür öffnet sich -> 1 person muss zugangsdaten haben
  7 verschiedene leute von maelstrom
  fangen sofort an zu zerstören
  eine person geht sofort zu access point + gibt sich mühe sein gesicht nicht in der kamera zu zeigen
  das büro wurde nicht zerstört
  finde mehrere vorrichtungen - anti tamperfallen, überall wo ich schlösser finde 
  tresor: bei zu starken erschütterungen wird gas freigesetzt
cyclops und brainfart gehören nicht zur führung von maelstrom
maelstrom sucht aktuell ein neues hq
es gab zwei cyber psycho fälle - sind auf maelstrom zurückzuführen
  -> keiner will mit ihnen geschäfte machen
jake martinez -> wird für gewöhlich mit einem auge dargestellt
das auge hat einen blick auf the fork geworfen -> wirtschaftlich interessant
  gab diebstähle von bodyweight systems 
die suche läuft anfangs nicht gut
...
-> vicky hat sich in letzter zeit immer wieder über ihren bruder beschwert
  ...
  vicky hat keine feste wohnadresse
  tavik holt - bruder von vicky, athlet, steht auf ner liste von bodyweight
  ist vor ein paar wochen mit eigebauter ware aufgetaucht -> ihm wurde der talent-vertrag gekündigt; 2 - 3 wochen
  war einer besseren natis
  hat nicht gedacht das er was falsches getan hätte, ist im streit auseinander gegangen
  ist ein sehr guter planer und macht gute vorbereitungen -> hat den spitznamen the brain bekommen
  der sport war seit einiger zeit nicht mehr sein fokus
  war beim letzten besuch fast schon auf kravall gebürstet
  steckt vermutlich hinter brainfart; hat gerne eine extreme idee (brainfart genannt) als ausgangspunkt genommen


  

# 2026-06-02
sind gerade in einer gefängsniszelle gefesselt
uns kommt ein konstrukt entgegen welches zu einem blitzangriff ausholt
eine frau hat mit ihren messern die panzerplatten gelöst
liam hat das konstrukt mit pfeilen beschossen
das konstrukt wurde am ende besiegt
-> ist ein braindance gewesen

begleiten greg zum black strap neon weil er dort buisness gespräche führen will
wir sind quasi als türsteher verdonnert -> werden bezahlt dafür
treffen dort vicktor rook
  ist in nox alter
kriegen echtes frisches essen (kubanische küche)
erledigen den job aber nicht unauffälig
